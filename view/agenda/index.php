                                            ...
                                            <div class="porlets-content" style="margin-bottom: -50px;">                                        
                                                <div class="form-row"><!--DATOS GENERALES-->
                                                    <div class="col-md-12 mb-12">
                                                        <label for="nomPaciente" class="control-label">Seleccione Paciente<strong class="theme_color"></strong></label>
                                                        <select name="nomPaciente" class="form-control select2" required style="width: 100%">
                                                          <option value="">
                                                            Selecciona...
                                                          </option>
<?php 
    foreach($this->model->ListarBeneficiarios() as $r):
    {
    ...
    <?php  endforeach; ?>                                                        </select>
                                                    ...
                                                    <input type="hidden" name="idPaciente" value="<?php echo $p->idPaciente != null ? $p->idPaciente : 0;  ?>"/>
                                        ...
                                        <div class="block-web">
                                            ...
                                            <div class="porlets-content" style="margin-bottom: -50px;">
                                                <div class="form-group">
                                                    ...
                                                    <div class="col-sm-4">
                                                        <input name="nombre" maxlength="50" id="nombre" type="text" class="form-control"  placeholder="Ingrese el nombre del paciente">
                                                    </div>
                                                    <div class="col-sm-4">
                                                        <input name="apePat" maxlength="50" id="apePat" type="text" class="form-control"  placeholder="Ingrese el Apellido Paterno del paciente">
                                                    </div>
                                                    <div class="col-sm-4">
                                                        <input name="apeMat" maxlength="50" id="apeMat" type="text" class="form-control"  placeholder="Ingrese el Apellido Materno del paciente">
                                                    </div>
                                                </div><!--/form-group--> <br><br>
                                                <div class="form-group">
                                                    <div class="col-sm-2" style="text-align: right;">
