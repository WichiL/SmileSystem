...
<!--\\\\\\\ inner start \\\\\\-->
    ...
    <div class="left_nav_slidebar">
        <ul>
          <li  <?php if (isset($inicio)){ ?> class="left_nav_active theme_border theme_color" <?php } else { ?> class="theme_border"  <?php } ?>>
            <a href="?c=inicio" style="font-size: 20px;"> <?php if (isset($inicio)){ ?><i class=" fa fa-home blue"><?php } else { ?> <i class="fa fa-home"> <?php } ?></i>Inicio</a>
          </li>
          <li  <?php if (isset($agenda)){ ?> class="left_nav_active theme_border" <?php } else { ?> class="theme_border" <?php } ?>>
            <a href="?c=agenda" style="font-size: 20px;"> <?php if (isset($agenda)){ ?><i class=" fa fa-briefcase blue"><?php } else { ?> <i class="fa fa-briefcase"> <?php } ?></i>Agenda</a>
          </li>
          <li  <?php if (isset($pacientes)){ ?> class="left_nav_active theme_border" <?php } else { ?> class="theme_border" <?php } ?>>
            <a href="?c=paciente" style="font-size: 20px;">  <?php if (isset($pacientes)){ ?><i class=" fa fa-users blue"><?php } else { ?> <i class="fa fa-users"> <?php } ?></i>Pacientes</a>
          </li>
      </div>
    </div>
    </div>
